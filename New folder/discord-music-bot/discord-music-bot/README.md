...
| Bot joins but no sound                                  | Almost always missing **`@discordjs/opus`** — make sure `npm install` finished cleanly. On low-RAM hosts, fall back: `npm i opusscript` and it'll auto-pick that up. |
